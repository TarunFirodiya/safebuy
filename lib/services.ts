...
export const services: Service[] = [
  ...
  },
  {
    ...
    notIncluded: [],
    oftenBundledWith: [
      "e-khata-documentation",
      "manual-to-e-khata-conversion",
      "e-khata-correction",
    ],
    metaTitle: "",
    metaDescription: "",
  ...
  {
    slug: "e-khata-documentation",
    name: "E-Khata Documentation",
    price: 24999,
    deliveryTime: "30 days",
    categories: ["before-buying", "for-owners"],
    shortDescription:
      "E-Khata registration where SafeBuy sources the supporting records and resolves document mismatches before filing.",
    result:
      "A registered E-Khata backed by a complete, internally consistent document set — sourced, reconciled, and filed on your behalf by a dedicated coordinator.",
    requirements: ["Sale Deed", "Aadhaar", "PAN Card", "Property Photo"],
    steps: [
      "Share your Sale Deed and ID — your coordinator confirms the property, survey number, and jurisdiction.",
      "We source the supporting records for you — Encumbrance Certificate, tax receipts, BESCOM and BWSSB bills, and the Khata extract.",
      "Our team reconciles every document against the Sale Deed and flags mismatches in name spelling, survey number, or extent.",
      "We resolve those discrepancies with the ward office before filing, so the application isn't rejected on paperwork.",
      "The E-Khata application is filed, and your coordinator follows up with the ward office until it clears.",
      "You receive your E-Khata along with the full reconciled document set.",
    ],
    notIncluded: [
      "Statutory fees, betterment charges, and property tax arrears payable to the authority",
      "Rectification of errors in the registered Sale Deed itself (see Rectification Deed)",
      "Litigation or representation in an ownership dispute",
    ],
    oftenBundledWith: ["e-khata-registration", "e-khata-correction"],
    metaTitle: "",
    metaDescription: "",
